...
ebr_drive_number:           db 0                    ; 0x00 floppy, 0x80
                            db 0                    ; reserved
ebr_signature:              db 29h
ebr_volume_id:              db 12h, 34h, 56h, 78h   ; serial number, value doesn't mean anything
ebr_volume_label:           db 'Another OS '        ; 11 bytes, padded with spaces
...
wait_key_and_reboot:
    ...
    jmp 0FFFFh:0                ; jump to beginning of BIOS, should reboots
...
.retry:
    pusha                                   ; saves all registers, we don't know what bios modifies
